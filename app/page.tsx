...
import AtomInputSelect from "@/components/atoms/inputs/AtomInputSelect";
...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <form
        className="card border border-gray-200 shadow-md p-5 rounded-md mt-5 grid lg:grid-cols-2 grid-cols-1 gap-4 w-full"
        onSubmit={handleSubmit(onSubmit)}
      >
           <span className="font-semibold border-b border-b-gray-200 pb-3 lg:col-span-2 col-span-1">
            Input Fields
          </span>
        ...
        <div className="flex flex-row lg:col-span-2 col-span-1">
          <button
            className="btn btn-ghost bg-primary text-gray-25 normal-case lg:ml-auto"
